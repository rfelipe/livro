...
public class BancoDeDados extends SQLiteOpenHelper {
    ...
    public static final String TABELA = "economics";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE if not exists "+TABELA+"(" + ID + " integer primary key autoincrement," + Nome + " text," + Pessoa + " text," + Data + " text,"+ Conta + " text,"+ Valor + " text)";
        db.execSQL(sql);
    }
    ...
    public boolean inserirRegistro(String sNome, String sPessoa,String sData,String sConta,String sValor) {
        ContentValues valores;

        db = getWritableDatabase();
        valores = new ContentValues();
        valores.put(Nome, sNome);
        valores.put(Pessoa, sPessoa);
        valores.put(Data, sData);
        valores.put(Conta, sConta);
        valores.put(Valor, sValor);
    ...
    public int alterarRegistro(int id, String sNome, String sPessoa,String sData,String sConta,String sValor){
        ContentValues valores;
        String where;
    ...
    public Cursor carregarDados(){
        Cursor cursor;
        String[] campos =  {ID,Nome,Pessoa,Data,Conta,Valor};
        db = getReadableDatabase();
