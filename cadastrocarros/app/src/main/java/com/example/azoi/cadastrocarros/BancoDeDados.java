...
public class BancoDeDados extends SQLiteOpenHelper {
    ...
    public  static final String  Endereço= "Endereço";
    public static final String Comida = "Comida";
    public static final String Preço = "Preço";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE if not exists "+TABELA+"(" + ID + " integer primary key autoincrement," + Nome + " text," + Endereço + " text," + Comida +" text,"+ Preço +" text)";
        db.execSQL(sql);
    }
    ...
    public boolean inserirRegistro(String sNome, String sEndereço, String sComida, String sPreço) {
        ...
        valores.put(Endereço, sEndereço);
        valores.put(Comida, sComida);
        valores.put(Preço, sPreço);
    ...
    public int alterarRegistro(int id, String sNome, String sEndereço, String sComida, String sPreço,String sValor){
        ContentValues valores;
        String where;
    ...
    public Cursor carregarDadoById(int id){
        Cursor cursor;
        String[] campos =  {ID,Nome,Endereço,Comida,Preço};
        String where = ID + "=" + id;
        db = getReadableDatabase();
